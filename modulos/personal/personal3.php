		...
		$client = new SoapClient(URL_WS_CONSULTA_NODO);
			if($client) {			
				...
				if($res)
				{
					...
					$empleado['nom_apellidopaterno']= $res->apellidopaterno;
					$empleado['nom_apellidomaterno']= $res->apellidomaterno;
					$empleado['fec_nacimiento']		= $res->fechanacimiento;
					$empleado['txt_rfc']			= $res->rfcempleado;
					...
					$empleado['cancelado']			= $res->cancelado;
			...
			if($res) {				
				...
				{					
					if($preEmpleado) {
						...
						$empleado['nom_apellidopaterno']= $preEmpleado->apellidopaterno;
